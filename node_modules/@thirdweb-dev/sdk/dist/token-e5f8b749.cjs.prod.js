...
class TokenImpl extends dist_thirdwebDevSdk.StandardErc20 {
  /**
   * Signature Minting
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.TokenErc20ContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, TokenImpl.contractRoles);
    ...
    this.history = new dist_thirdwebDevSdk.TokenERC20History(this.contractWrapper, this.events);
    ...
    this.signature = new dist_thirdwebDevSdk.Erc20SignatureMintable(this.contractWrapper, this.roles);
  }
  /** ******************************
   * READ FUNCTIONS
   *******************************/
...
dist_thirdwebDevSdk._defineProperty(TokenImpl, "contractRoles", ["admin", "minter", "transfer"]);
