...
class TokenDropImpl extends dist_thirdwebDevSdk.StandardErc20 {
  /**
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.DropErc20ContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, TokenDropImpl.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(TokenDropImpl, "contractRoles", ["admin", "transfer"]);

exports.TokenDropImpl = TokenDropImpl;
