...
const EditionDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([EditionDrop.getAbi(), Promise.resolve().then(function () { return require('./edition-drop-7c2aee0e.cjs.prod.js'); })]);
...
const Edition = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Edition.getAbi(), Promise.resolve().then(function () { return require('./edition-d0e44149.cjs.prod.js'); })]);
...
const Marketplace = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Marketplace.getAbi(), Promise.resolve().then(function () { return require('./marketplace-5747d501.cjs.prod.js'); })]);
...
const Multiwrap = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Multiwrap.getAbi(), Promise.resolve().then(function () { return require('./multiwrap-e6105546.cjs.prod.js'); })]);
...
const NFTCollection = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTCollection.getAbi(), Promise.resolve().then(function () { return require('./nft-collection-4cdf60bf.cjs.prod.js'); })]);
...
const NFTDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTDrop.getAbi(), Promise.resolve().then(function () { return require('./nft-drop-d056c87a.cjs.prod.js'); })]);
...
const Pack = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Pack.getAbi(), Promise.resolve().then(function () { return require('./pack-3e200d32.cjs.prod.js'); })]);
...
const SignatureDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([SignatureDrop.getAbi(), Promise.resolve().then(function () { return require('./signature-drop-caa26c4e.cjs.prod.js'); })]);
...
const Split = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Split.getAbi(), Promise.resolve().then(function () { return require('./split-f8863db0.cjs.prod.js'); })]);
...
const TokenDrop = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([TokenDrop.getAbi(), Promise.resolve().then(function () { return require('./token-drop-d31bdb4c.cjs.prod.js'); })]);
...
const Token = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Token.getAbi(), Promise.resolve().then(function () { return require('./token-17b414cb.cjs.prod.js'); })]);
...
const Vote = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([Vote.getAbi(), Promise.resolve().then(function () { return require('./vote-6859eb84.cjs.prod.js'); })]);
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContract(address) {
    ...
    try {
      ...
      invariant__default["default"](contractType !== "custom", "custom contract type");
