...
class SplitImpl {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.SplitsContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, SplitImpl.contractRoles);
  ...
  async balanceOfToken(walletAddress, tokenAddress) {
    ...
    return await dist_thirdwebDevSdk.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, value);
  }
  /**
...
dist_thirdwebDevSdk._defineProperty(SplitImpl, "contractRoles", ["admin"]);

exports.SplitImpl = SplitImpl;
