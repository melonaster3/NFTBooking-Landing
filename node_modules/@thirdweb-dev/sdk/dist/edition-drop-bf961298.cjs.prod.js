...
class EditionDropImpl extends dist_thirdwebDevSdk.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    dist_thirdwebDevSdk._defineProperty(this, "history", void 0);
    ...
    this.abi = abi;
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.DropErc1155ContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, EditionDropImpl.contractRoles);
    ...
    this.claimConditions = new dist_thirdwebDevSdk.DropErc1155ClaimConditions(this.contractWrapper, this.metadata, this.storage);
    this.events = new dist_thirdwebDevSdk.ContractEvents(this.contractWrapper);
    this.history = new dist_thirdwebDevSdk.DropErc1155History(this.events);
  ...
  async getClaimTransaction(destinationAddress, tokenId, quantity) {
    ...
    const claimVerification = await this.erc1155.claimConditions.prepareClaim(tokenId, quantity, checkERC20Allowance);
...
dist_thirdwebDevSdk._defineProperty(EditionDropImpl, "contractRoles", ["admin", "minter", "transfer"]);

exports.EditionDropImpl = EditionDropImpl;
