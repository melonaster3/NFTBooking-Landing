...
class EditionImpl extends dist_thirdwebDevSdk.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.abi = abi;
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.TokenErc1155ContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, EditionImpl.contractRoles);
    ...
    this.signature = new dist_thirdwebDevSdk.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
...
dist_thirdwebDevSdk._defineProperty(EditionImpl, "contractRoles", ["admin", "minter", "transfer"]);

exports.EditionImpl = EditionImpl;
