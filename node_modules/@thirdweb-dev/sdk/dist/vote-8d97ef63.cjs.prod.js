...
class VoteImpl {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.VoteContractSchema, this.storage);
  ...
  async getProposalVotes(proposalId) {
    ...
    return [{
      type: dist_thirdwebDevSdk.VoteType.Against,
      label: "Against",
      count: votes.againstVotes
    }, {
      type: dist_thirdwebDevSdk.VoteType.For,
      label: "For",
      count: votes.forVotes
    }, {
      type: dist_thirdwebDevSdk.VoteType.Abstain,
      label: "Abstain",
  ...
  async balanceOfToken(tokenAddress) {
    ...
    return await dist_thirdwebDevSdk.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
  /**
  ...
  async settings() {
    ...
    const votingTokenMetadata = await dist_thirdwebDevSdk.fetchCurrencyMetadata(this.contractWrapper.getProvider(), votingTokenAddress);
    return {
