...
class NFTDropImpl extends dist_thirdwebDevSdk.StandardErc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    dist_thirdwebDevSdk._defineProperty(this, "claimConditions", void 0);

    dist_thirdwebDevSdk._defineProperty(this, "revealer", void 0);

    dist_thirdwebDevSdk._defineProperty(this, "erc721", void 0);

    this.abi = abi;
    this.metadata = new dist_thirdwebDevSdk.ContractMetadata(this.contractWrapper, dist_thirdwebDevSdk.DropErc721ContractSchema, this.storage);
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, NFTDropImpl.contractRoles);
    ...
    this.claimConditions = new dist_thirdwebDevSdk.DropClaimConditions(this.contractWrapper, this.metadata, this.storage);
    ...
    this.revealer = new dist_thirdwebDevSdk.DelayedReveal(this.contractWrapper, this.storage, dist_thirdwebDevSdk.FEATURE_NFT_REVEALABLE.name, () => this.erc721.nextTokenIdToMint());
  ...
  async getAllClaimed(queryParams) {
    ...
    const count = ethers.BigNumber.from((queryParams === null || queryParams === void 0 ? void 0 : queryParams.count) || dist_thirdwebDevSdk.DEFAULT_QUERY_ALL_COUNT).toNumber();
  ...
  async getClaimTransaction(destinationAddress, quantity) {
    ...
    return dist_thirdwebDevSdk.TransactionTask.make({
  ...
  async prepareClaim(quantity, checkERC20Allowance) {
    return dist_thirdwebDevSdk.prepareClaim(quantity, await this.claimConditions.getActive(), async () => (await this.metadata.get()).merkle, 0, this.contractWrapper, this.storage, checkERC20Allowance);
  }
  /**
   * @internal
   */
...
dist_thirdwebDevSdk._defineProperty(NFTDropImpl, "contractRoles", ["admin", "minter", "transfer"]);

exports.NFTDropImpl = NFTDropImpl;
