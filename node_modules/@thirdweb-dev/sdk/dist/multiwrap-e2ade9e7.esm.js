...
class MultiwrapImpl extends StandardErc721 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new ContractRoles(this.contractWrapper, MultiwrapImpl.contractRoles);
...
_defineProperty(MultiwrapImpl, "contractRoles", ["transfer", "minter", "unwrap", "asset"]);

export { MultiwrapImpl };
