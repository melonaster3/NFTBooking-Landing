...
class SignatureDropImpl extends dist_thirdwebDevSdk.StandardErc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, SignatureDropImpl.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(SignatureDropImpl, "contractRoles", ["admin", "minter", "transfer"]);

exports.SignatureDropImpl = SignatureDropImpl;
